...
<div id="wrapper">
		...
		<div id="body" class="clear">
				...
				<ul>
                	<li>
                        ...
                        <ul class="blocklist">
                            ...
                            <li class="selected-item"><a href="#">Consulter</a></li>
			...
			<div id="content" class="column-right">
				...
				<s:form action=" st.html" method="post" enctype="multipart/form-data" id="searchbox5">
        <input id="search51" name="matricule" type="text" size="40" placeholder="Search..." />
    </s:form><br/><br/>
        	
				

				<blockquote><p>Pour consulter la liste de PV des etudiants avec leurs refference et les matricules des etudiants cliquez sur le lien ci-dessous</p></blockquote>
				<p>&nbsp;</p>
				<center>
				 <sup>&darr;</sup><br/>
                <a href="#" onclick="upDom('stat.html','contenue')" class="button"  >
                 <span >Hover Me</span>
                    </a><br/><br/><br/>
				</center>
