...
<div id="wrapper">
       ...
       <h3> Ajouter un PV a l etudiant precedant </h3>
       <input type="hidden" name="matricule" value="<c:out value="${sessionScope.etd}"/>" size="20" maxlength="60" />
             <s:textfield id="inpu" placeholder="description...." name="description" size="40" />
     ...
     <s:textfield id="datepicker" name="date" placeholder="la date du pv..." format="MM/dd/yyyy" size="40"/>
        <s:file name="userImage"  />
      <s:submit id="sub" onclick="upDomFrmValidate('savPv.html','container','xy','description;;1;;.*::type;;1;;.*::date;;1;;.*');return false;"  value="suivant"></s:submit>
      </s:form>
				 </div>
				 </center>
