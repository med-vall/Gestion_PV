...
<h3>la liste de membres</h3>
 ...
 <s:iterator value="users" var="f">
             <tr>
                 ...
                 <td><a href="#" onclick="upDom('deleteUser.html?param=<s:property  value="#f.idUser"/>','contenue')"><img src="images/delete.png" style="cursor:pointer; "  title="Supprimer"   /></a></td>
                 <td><a href="updatefournisseur?param=<s:property  value="#f.idUser"/>"><img src="images/edit.png" style="cursor:pointer; "  title="Modifier"   /></a></td>
            </tr>   </s:iterator>
            </table>
             <p>&nbsp;</p>
            <table>
				<tr>
				<td></td>
				<td><a href="AjoutMembr.jsp" class="butto"><span class="user">Ajouter Membre</span></a></td>
				</tr>
            </table>
